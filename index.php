...
<body>
    ...
    <section id="hero">
        <div class="hero-container">
            <h1>Bienvenido a SHM</h1>
            <h2>Maquinados Industriales y Maquila Plástica</h2>
    ...
    <header id="header" class="d-flex align-items-center ">
        <div class="container-fluid d-flex align-items-center justify-content-lg-between">
            ...
            <!-- <a href="index.php" class="logo me-auto me-lg-0"><img src="assets/img/shm-logo.png" alt="" class="img-fluid"></a> -->
    ...
    <main id="main">
        ...
        <section id="products" class="portfolio">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Productos</h2>
                    <p>Contamos con una variedad de productos.</p>
                </div>
                ...
                <div class="row portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        ...
                        <div class="portfolio-info">
                            <!-- <h4>App 1</h4> -->
                            <p>Alcoholera 1-2 (medio) R-28 35g</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        ...
                        <div class="portfolio-info">
                            <!-- <h4>App 2</h4> -->
                            <p>Alcoholero 1-8 (un octavo) R-28 15g</p>
    ...
    <footer id="footer">
        ...
        <div class="container footer-bottom justify-content-center clearfix">
            <div class="copyright">
                &copy; Copyright <strong><span>SHM</span></strong>. Todos los derechos reservados
            </div>
        </div>
    </footer>
    <!-- End Footer -->
